...
urlpatterns = [
    ...
    path('accounts/<int:object_id>/profile/', views.UnavailableProductView.as_view(), name = 'unavailable'),
    path('accounts/<int:object_id>/profile/', views.AvailableProductView.as_view(), name='available'),
